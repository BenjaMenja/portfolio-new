...
export const projectList = [
      {
        ...
        status: { publisher: 'MassDiGi', role: 'Programmer, Build Engineer', tools: 'C# / Unity, Miro, Fastlane, Plastic SCM', dates: 'September 2023 - January 2024' }
    },
    {
        title: 'Color Clash',
        ...
        project: 'color-clash',
        status: { role: 'Gameplay Programmer, Level Designer, Data Analyst', tools: 'C#, Python / Unity, Pandas, Matplotlib', dates: 'September 2023 - April 2024' }
    },
    {
        ...
        status: { role: 'Programmer, Website Designer, Puzzle Designer', tools: 'Blueprints / Unreal Engine', dates: 'March 2023 - May 2023' }
    },
    {
        ...
        project: 'game-engine',
        status: { role: 'Programmer', tools: 'C++ / Visual Studio', dates: 'January 2023 - March 2023' }
    },
    {
        title: 'PokeQuiz',
        ...
        project: 'pokequiz',
        status: { role: 'Programmer, Designer', tools: 'HTML, CSS, TypeScript / Angular, Tailwind, Chart.js', dates: 'March 2025 - April 2025' }
    },
    {
        title: 'Royal Siege',
        ...
        project: 'royal-siege',
        status: { role: 'Lead Developer, Lead Programmer, Lead Map Designer', tools: 'mcfunction / Minecraft, Blockbench', dates: 'December 2020 - January 2025' }
    },
    {
        ...
        project: 'tfc-ti',
        status: { role: 'Developer, Programmer', tools: 'Java, ZenScript, JSON / Minecraft, Gradle', dates: 'February 2025 - March 2025' }
    },
    {
        title: 'Blockle',
        imgsrc: blockleimg,
        ...
        project: 'blockle',
        status: { role: 'Programmer', tools: 'Typescript, React / Playwright', dates: 'November 2024 - December 2024' }
    },
    {
        title: 'Pokemon Blitz',
        ...
        status: { role: 'Programmer, ASCII Artist', tools: 'C++ / Visual Studio', dates: 'February 2023 - March 2023' }
    }
]