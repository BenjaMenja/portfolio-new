        ...
        <div>
            ...
            <Card className={'border-0'} style={{
                ...
                <CardText tag="h4" style={{
                    ...
                    Graphics and sound support are provided through <a style={{color: "#95C0FE"}} href="https://www.sfml-dev.org/">SFML</a>.
                    The game <a style={{color: "#95C0FE"}} href='/pokemon-blitz'>Pokemon Blitz</a> was built using this engine.
                    <br></br>
                    <br></br>
                </CardText>
            </Card>
