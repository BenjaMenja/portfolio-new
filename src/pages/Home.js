    ...
    return (
        <div style={{color: '#FFFFFF'}}>
            ...
            <Row xs={'4'}>
                <Col/>
                <Col>
                    <Button aria-label="GitHub Button" style={{backgroundColor: 'rgba(0,0,0,0)', borderColor: 'rgba(0,0,0,0)'}} onClick={() => {window.location.href="https://github.com/BenjaMenja"}}>
                ...
                <Col>
                    <Button aria-label="LinkedIn Button" style={{backgroundColor: 'rgba(0,0,0,0)', borderColor: 'rgba(0,0,0,0)'}} onClick={() => {window.location.href="https://www.linkedin.com/in/benjamin-gelinas-4679b723b"}}>
                        <svg fill={"#FFFFFF"} xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 64 64">
