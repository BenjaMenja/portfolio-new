...
export function GithubButton() {
    return (
        <Button style={{backgroundColor: 'rgba(0,0,0,0)', borderColor: 'rgba(0,0,0,0)'}} href={"https://github.com/BenjaMenja"}>
...
export function LinkedInButton() {
    return (
        <Button style={{backgroundColor: 'rgba(0,0,0,0)', borderColor: 'rgba(0,0,0,0)'}} href={"https://www.linkedin.com/in/benjamin-gelinas-4679b723b"}>
            <svg fill={"#FFFFFF"} className={"about-link-svg"} xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 64 64">
...
export function ItchButton() {
    return (
        <Button style={{backgroundColor: 'rgba(0,0,0,0)', borderColor: 'rgba(0,0,0,0)'}} href={"https://benjamenja.itch.io/"}>
